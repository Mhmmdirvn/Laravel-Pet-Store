            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 gap-3 fs-6 ">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="{{ url('tentang') }}">Tentang kami</a>
                        </li>
                        <li class="nav-item">
            ...
            <div class="row align-items-center">
                <div class="col-lg-6 pe-lg-5 mb-lg-0 mb-5">
                    <div class="position-relative">
                        <h3 class="title-style mb-3">Siapakah kami dan apa yang kami lakukan ?</h3>
                    ...
                    <p>Kami adalah pecinta hewan, kami merawat hewan peliharaan agar mereka tetap senang. Membuat hewan
                        senang dan sehat adalah tugas kami </p>

                </div>
                <div class="col-lg-6 homeaboutblock">
                    <div class="position-relative img-border">
                        <img src="{{ url('images/about3.jpg') }}" class="img-fluid radius-image shadow-sm"
                            alt="video-popup">
        ...
        <div class="container pb-md-5 pb-4">
            <div class="row">
                <div class="col-md-3 col-6 grids-1">
                    ...
                    <h4 class="title-head mt-2 mb-3">Diagnosa
                    </h4>
                ...
                <div class="col-md-3 col-6 grids-1">
                    ...
                    <p>Kami sudah mendapatkan beberapa penghargaan, jadi sudah menjadi pilihan yang tepat datang ke
                        tempat kami.</p>
                </div>
                <div class="col-md-3 col-6 grids-1 mt-md-0 mt-5">
                    <i class="fas fa-bone color-2"></i>
                    <h4 class="title-head mt-2 mb-3">Perkawinan</h4>
                    <p>Jika anda ingin mengawinkan hewan peliharaan anda, disini sudah disediakan agar hewan anda dapat
                        berkembang biak.</p>
                </div>
                <div class="col-md-3 col-6 grids-1 mt-md-0 mt-5">
                    <i class="fas fa-paw color-4"></i>
                    <h4 class="title-head mt-2 mb-3">Pelatihan</h4>
                    <p>Disini juga terdapat pelatihan untuk hewan, jadi hewan anda bisa aktif bergerak dan bermain.</p>
                </div>
            </div>
        </div>
    </section>

    <section class="sec-team py-5" id="team">
        <div class="container py-md-5 py-4">
            <div class="position-relative">
                <h3 class="title-style text-center mb-sm-5 mb-4">Temui Tim Luar Biasa kami</h3>
                <div class="title-paw-style">
                    <i class="fas fa-paw"></i>
                    <i class="fas fa-paw paw-2"></i>
                    <i class="fas fa-paw paw-3"></i>
            ...
            <div class="row text-center">
                <div class="col-md-3 col-6">
                    <div class="team-grids text-center">
                        <img src="{{ url('images/team1.jpg') }}" class="img-fluid" alt="">
                        <div class="team-info">
                            <div class="caption">
                ...
                <div class="col-md-3 col-6">
                    <div class="team-grids text-center">
                        <img src="{{ url('images/team3.jpg') }}" class="img-fluid" alt="">
                        <div class="team-info">
                            <div class="caption">
                                <div class="social-icons-section text-center">
                                    <a class="fac" href="#url">
                ...
                <div class="col-md-3 col-6 mt-md-0 mt-sm-5 mt-5">
                    <div class="team-grids text-center">
                        <img src="{{ url('images/team2.jpg') }}" class="img-fluid" alt="">
                        <div class="team-info">
                            <div class="caption">
                                <div class="social-icons-section text-center">
                                    <a class="fac" href="#url">
                ...
                <div class="col-md-3 col-6 mt-md-0 mt-sm-5 mt-5">
                    <div class="team-grids text-center">
                        <img src="{{ url('images/team4.jpg') }}" class="img-fluid" alt="">
                        <div class="team-info">
                            <div class="caption">
                                <div class="social-icons-section text-center">
                                    <a class="fac" href="#url">
